...
<meta charset="UTF-8">
    ...
    <title>Coffee shop | Sản phẩm yêu thích</title>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="shoping__cart__item">
                                        <img src="../../public/sanpham/products/{{ $item -> thumbnail}}.jpg" width="20%">
                                        <h5>{{ $item -> name }}</h5>
                                    </td>
                                ...
                                {{ number_format($item -> price) }} đ
                                    ...
                                    <td><a href="{{ route('del_like') }}?id={{$item -> like_id}}"><button type="button" class="btn btn-danger">Xóa</button></a>
                                    </td>
                                    <td><a href="{{ route('det') }}?id={{$item -> id}}"><button type="button" class="btn btn-info">Xem chi tiết</button></a>
                                    </td>
                                </tr>
                                @endforeach  
