...
<head>
    ...
    <title>Coffee shop | Thanh toán</title>
...
<div class="row" style="padding-top:6%;padding-bottom: 6%;">
    ...
    <div class="col-lg-8">
                <form action="{{route('ttc')}}" method="post"> 
                  <input type="hidden" id="_token" name="_token" value="{{ csrf_token() }}"/>
     <div class="form-group">
      <label for="name">Nhập họ và tên</label>
      <input type="text" class="form-control" id="name" placeholder="Nhập tên" name="n">
    </div>
    <div class="form-group">
      <label for="">Nhập địa chỉ</label>
      <input type="text" class="form-control" id="pwd" placeholder="Nhập địa chỉ" name="a">
    </div>
    <div class="form-group">
      <label for="phone">Nhập số điện thoại</label>
      <input type="number" class="form-control" id="pwd" placeholder="Nhâp số điện thoại" name="p">
    </div>
     <p><center><button class="primary-btn" style="border: 0px;">Mua hàng</button></center></p>
</form>
</div>
<div class="col-lg-2"></div>
    <div class="col-lg-12">
