    ...
    <section class="breadcrumb-section set-bg" data-setbg="https://caphenguyenchat.org/wp-content/uploads/hinh-3.jpg">
        <div class="container">
            ...
            <div class="row" style="padding-bottom: 10%;">
                ...
                <div class="col-lg-6" >
                    <div class="a" style="padding-bottom:6%;margin-bottom: 5%;">
                <a href="{{ route('newdet') }}?id={{$item -> id}}">
                    <img src="../../public/sanpham/tintuc/{{ $item -> thumbnail}}.jpg">
                    <b style="padding-top: 10px;color: black;">{{$item -> title}}</b>
                </a>
                    <p >{{$item -> demo}}</p>
                    <center><a href="{{ route('newdet') }}?id={{$item -> id}}"><button>Xem thêm</button></a></center>
